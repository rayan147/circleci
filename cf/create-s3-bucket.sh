S3_TEMPLATE_POLICY_NAME=${S3_TEMPLATE_NAME:?"S3_TEMPLATE_NAME is not set"}
S3_TEMPLATE_BUCKETS_NAME=${S3_TEMPLATE_BUCKETS_NAME:?"S3_TEMPLATE_BUCKETS_NAME is not set"}
